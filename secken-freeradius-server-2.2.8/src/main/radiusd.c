...
#define SECKEN_CONF RADDBDIR"/secken.conf"

	if (radiusd_ext_init(SECKEN_CONF) < 0) {
		fprintf(stderr, "radiusd: external init error.\n");
		radlog(L_ERR, "radiusd: external init error.\n");
		exit(1);
	}
